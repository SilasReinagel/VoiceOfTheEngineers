...
export const suggestion = (id, title, detail, createdDateTime, lastActivityDateTime, numUpvotes, numComments, upvotedByCurrentUser) => 
  ({ id, title, detail, createdDateTime, lastActivityDateTime, numUpvotes, numComments, upvotedByCurrentUser });

const testSuggestions = [ 
  suggestion(0, 'Simplify Deployment Process - 1-Click Approval to Deploy', ipsum3, '5/27/21', '5/27/21', 26, 2, false),
  suggestion(1, 'Create F# Web API Template', ipsum1, '5/29/21', '5/29/21', 8, 0, true),
  suggestion(2, 'This Is An Example Very Very, Very, Very, Very, Very, Very, Very, Very, Very, Very Long Suggestion', ipsum3, '5/29/21', '5/29/21', 4, 1, false),
];
