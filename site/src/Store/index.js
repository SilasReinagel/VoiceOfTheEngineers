...
export const suggestion = (title, detail, createdDateTime, lastActivityDateTime, upvotes, numComments) => ({ title, detail, createdDateTime, lastActivityDateTime, upvotes, numComments });
const testSuggestions = [ 
  suggestion('Simplify Deployment Process - 1-Click Approval to Deploy', ipsum3, '5/27/21', '5/27/21', 26, 2),
  suggestion('Create F# Web API Template', ipsum1, '5/29/21', '5/29/21', 8, 0),
  suggestion('This Is An Example Very Very, Very, Very, Very, Very, Very, Very, Very, Very, Very Long Suggestion', ipsum3, '5/29/21', '5/29/21', 4, 1),
];
